...
export class Agent {
   ...
   * @param {import('./agent/types.js').AgentOptions<S>} [options]
   */
   ...
   * @param {import('./agent/types.js').AgentOptions<R> & import('./agent/types.js').AgentDataOptions} [options]
   */
  /* c8 ignore next 4 */
   ...
   * @template {API.Caveats} [C={}]
   * @param {CAP} cap
   * @param {import('./agent/types.js').InvokeOptions<A, R, CAP>} options
   */
