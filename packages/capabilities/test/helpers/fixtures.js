...
export const aliceAccount = Absentee.from({ id: 'did:mailto:test.web3.storage:alice' })
...
export const bobAccount = Absentee.from({ id: 'did:mailto:test.web3.storage:bob' })
...
export const malloryAccount = Absentee.from({ id: 'did:mailto:test.web3.storage:mallory' })
